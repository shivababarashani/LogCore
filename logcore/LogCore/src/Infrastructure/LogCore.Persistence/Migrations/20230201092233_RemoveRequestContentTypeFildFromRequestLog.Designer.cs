...
namespace LogCore.Persistence.Migrations
{
    ...
    [Migration("20230201092233_RemoveRequestContentTypeFildFromRequestLog")]
    partial class RemoveRequestContentTypeFildFromRequestLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.ActionLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 2, 1, 1, 22, 32, 910, DateTimeKind.Local).AddTicks(1331));
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.RequestLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 1, 1, 22, 32, 910, DateTimeKind.Local).AddTicks(973));
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.StateLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 1, 1, 22, 32, 910, DateTimeKind.Local).AddTicks(1654));
