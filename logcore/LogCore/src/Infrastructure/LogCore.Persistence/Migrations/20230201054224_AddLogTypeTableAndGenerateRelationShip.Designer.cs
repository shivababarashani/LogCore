...
namespace LogCore.Persistence.Migrations
{
    ...
    [Migration("20230201054224_AddLogTypeTableAndGenerateRelationShip")]
    partial class AddLogTypeTableAndGenerateRelationShip
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.ActionLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 1, 31, 21, 42, 23, 904, DateTimeKind.Local).AddTicks(1763));
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.RequestLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 21, 42, 23, 904, DateTimeKind.Local).AddTicks(1384));
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.StateLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 21, 42, 23, 904, DateTimeKind.Local).AddTicks(2103));
