...
namespace LogCore.Persistence.Migrations
{
    ...
    [Migration("20230130144152_AddRelationShipBetweenTransactionTypeAndActionLog")]
    partial class AddRelationShipBetweenTransactionTypeAndActionLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.ActionLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 1, 30, 6, 41, 52, 611, DateTimeKind.Local).AddTicks(394));
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.RequestLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 30, 6, 41, 52, 611, DateTimeKind.Local).AddTicks(32));
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.StateLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 30, 6, 41, 52, 611, DateTimeKind.Local).AddTicks(711));
