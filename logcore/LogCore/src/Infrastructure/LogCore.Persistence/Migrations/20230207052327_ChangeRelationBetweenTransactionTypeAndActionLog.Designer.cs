...
namespace LogCore.Persistence.Migrations
{
    ...
    [Migration("20230207052327_ChangeRelationBetweenTransactionTypeAndActionLog")]
    partial class ChangeRelationBetweenTransactionTypeAndActionLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.ActionLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 2, 6, 21, 23, 27, 166, DateTimeKind.Local).AddTicks(2401));
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.RequestLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 6, 21, 23, 27, 166, DateTimeKind.Local).AddTicks(1666));
            ...
            modelBuilder.Entity("LogCore.Domain.Entities.StateLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 6, 21, 23, 27, 166, DateTimeKind.Local).AddTicks(2832));
